...
// 支持的预览参数类型
#define CAMERA_PARAMETER_PREVIEW_SIZE 0
#define CAMERA_PARAMETER_DISPLAY_TRANSFORM 1
#define CAMERA_PARAMETER_AUTO_EXPOSURE 2
#define CAMERA_PARAMETER_EXPOSURE 3
#define CAMERA_PARAMETER_BRIGHTNESS 4
#define CAMERA_PARAMETER_CONTRAST 5
#define CAMERA_PARAMETER_GAIN 6
#define CAMERA_PARAMETER_SATURATION 7
#define CAMERA_PARAMETER_ZOOM 8
