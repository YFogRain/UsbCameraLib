...
val appScope by lazy { ProcessLifecycleOwner.get().lifecycleScope }
...
//	val aClass = this.com.rain.uvc.demo.utils.findBaseGenericType<T>(BaseViewBindFragment::class.java) ?: throw IllegalArgumentException("ViewBinding class type not found.")
...
//	val aClass = this.com.rain.uvc.demo.utils.findBaseGenericType<T>(BaseViewBindActivity::class.java) ?: throw IllegalArgumentException("ViewBinding class type not found.")
