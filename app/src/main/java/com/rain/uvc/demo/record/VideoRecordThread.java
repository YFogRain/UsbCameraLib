...
public class VideoRecordThread extends Thread implements Runnable {
    ...
    public VideoRecordThread(MediaMuxerThread mMutex, int width, int height) {
        ...
        this.width = width;
        this.height = height;
        this.dataQueue = new ArrayBlockingQueue<>(30);
        this.isRecording = false;
        this.mBitRate = width * height * mFrameRate * 2 / 30;
    ...
    private boolean initMediaCodec(int width, int height) {
        try {
            ...
            mediaFormat.setInteger(MediaFormat.KEY_BIT_RATE, 2_500_000);
    ...
    public boolean prepare() {
        return initMediaCodec(width, height);
    }
