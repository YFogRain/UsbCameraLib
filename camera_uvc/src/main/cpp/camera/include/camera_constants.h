...
#define PREVIEW_FORMAT_YUY2 1   // 即 YUYV (Y0 U Y1 V) 4:2:2 packed
#define PREVIEW_FORMAT_NV21 2   // YUV420 semi-planar，UV 平面按 V/U 顺序交错
#define PREVIEW_FORMAT_NV12 3   // YUV420 semi-planar，UV 平面按 U/V 顺序交错
#define PREVIEW_FORMAT_RGBA 4
#define PREVIEW_FORMAT_RGB 5
#define PREVIEW_FORMAT_MJPEG 6
#define PREVIEW_FORMAT_JPEG 7
#define PREVIEW_FORMAT_YUV420SP 8 // 通用 YUV420 semi-planar，等价于 NV12（U/V 顺序交错）
